...
## Mobile monitoring {.center .center-x}
...
## MM data visualised in R {.center .center-x}
...
- Using [`tmap`](https://r-tmap.github.io/tmap/index.html)
...
- Machine learning model:
  - [`Random forest`](https://link.springer.com/article/10.1023/a:1010933404324?utm_source=getftr&utm_medium=getftr&utm_campaign=getftr_pilot)
- Geostatistical model:
  - [`Geographically weighted regression`](https://onlinelibrary.wiley.com/doi/abs/10.1111/j.1538-4632.1996.tb00936.x)
